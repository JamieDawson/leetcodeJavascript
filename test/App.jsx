  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="p-6 bg-white rounded shadow-lg">
        ...
        <div className="mb-3">
          <label htmlFor="principal" className="block mb-2 text-sm font-medium text-gray-700">Principal Amount ($):</label>
          <input
            type="number"
            id="principal"
            value={principal}
        ...
        <div className="mb-3">
          <label htmlFor="rate" className="block mb-2 text-sm font-medium text-gray-700">Annual Interest Rate (%):</label>
          <input
            type="number"
            id="rate"
            value={rate}
        ...
        <div className="mb-3">
          <label htmlFor="time" className="block mb-2 text-sm font-medium text-gray-700">Time (Years):</label>
          <input
            type="number"
            id="time"
            value={time}
